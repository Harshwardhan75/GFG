<h2><a href="https://www.geeksforgeeks.org/problems/queue-using-stack/1?page=2&sprint=ca8ae412173dbd8346c26a0295d098fd&sortBy=submissions">Queue using stack</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Implement a Queue&nbsp;using two stack</span><span style="font-size: 18px;"><strong>&nbsp;s1</strong>&nbsp;and<strong>&nbsp;s2</strong>.</span></p>
